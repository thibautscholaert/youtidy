...
export function HeroSection() {
  ...
  return (
    <section className="relative pt-16 sm:pt-20 pb-16 overflow-hidden section">
      ...
      <div className="container mx-auto pt-4 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <button className="retro-button-accent flex items-center justify-center gap-2" onClick={() => scrollTo('demo')}>
              <span className="text-lg"><RocketIcon className='w-5 h-5 inline'/> Get started</span>
            </button>
          </motion.div>
